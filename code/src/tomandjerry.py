...
PROMPT_FILENAME = "tomandjerry.txt"
REPO_URL = "https://github.com/cicl-stanford/marple_text"
CSV_DIR = "tomandjerry"
CSV_NAME = "tomandjerry.csv"
...
State Change Question: {state_change_question}
Future Action Question: {future_action_question}
Belief Explicit Aware: {belief_explicit_aware}
State Implicit Aware: {state_implicit_aware}
Belief Explicit Not Aware: {belief_explicit_not_aware}
State Implicit Not Aware: {state_implicit_not_aware}
...
Not aware of random event: {not_aware_of_random_event}"""
    ...
    template_var = [
        ...
        "action_init",
        "reasoning_question",
        "state_change_question",
        "future_action_question",
        "belief_explicit_aware",
        "state_implicit_aware",
        "belief_explicit_not_aware",
        "state_implicit_not_aware",
        "random_event",
    ...
    for n_story in tqdm.tqdm(range(0, args.num_stories, args.num_completions)):
        ...
        for g, generation in enumerate(responses.generations[0]):
            ...
            list_var = [
                ...
                "Belief Explicit Aware",
                "State Implicit Aware",
                "Belief Explicit Not Aware",
                "State Implicit Not Aware",
                "Random Event",
